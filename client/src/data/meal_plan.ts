...
const week1: PlanWeek = {
  ...
  days: [
    ...
    { label: "Day 3", note: "Clear liquids · 1 oz sips · goal 48-64 oz fluids.", meals: week1ClearMeals },
    { label: "Day 4", note: "Full liquids begin · 2-4 oz per meal · goal 60g protein.", meals: week1FullMeals },
    ...
    { label: "Day 7", note: "Full liquids · 2-4 oz per meal · goal 60g protein.", meals: week1FullMeals },
  ],
  shopping: [
